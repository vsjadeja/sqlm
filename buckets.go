...
var (
	...
	// TimeBucketsExtended suits for GO APIs that have long-duration response, where response time is between 50ms..30000ms.
	TimeBucketsExtended = []float64{0.001, 0.005, 0.015, 0.05, 0.1, 0.25, 0.5, 0.75, 1, 1.5, 2, 3.5, 5, 7, 10, 15, 30}
